...
namespace MatchCenter
{
    public partial class addmatch : System.Web.UI.Page
    {
        ...
        protected void btnHomeTeamNext_Click(object sender, EventArgs e)
        {
            ...
            Session["teamNameHome"] = txtHomeTeamName.Text;
            ...
            { 
                ...
                for (int i = 0; i < textboxNames.Length; i++)
                {
                    ...
                    PlayerList.Add(p);
                    Session["lineupHome"] = PlayerList;
                }
            }
           Response.Redirect("addAwayTeam");
    ...
    //        string query = "INSERT INTO matches (place, competition, user_id) VALUES (@place, @competition, @user_id) returning match_id ";
    //        //string conString = ConfigurationManager.ConnectionStrings["constr"].ConnectionString;
    //        using (NpgsqlConnection con = new NpgsqlConnection(Properties.Settings.Default.dbConnectionString))
    //        {
    ...
    //                cmd.Parameters.AddWithValue("@place", txtTitle.Text);
    //                cmd.Parameters.AddWithValue("@competition", txtBody.Text);
    //                cmd.Parameters.AddWithValue("@user_id", myCookie["_id"].ToString());
    //                con.Open();
    //                match_id = (int)cmd.ExecuteScalar();
    //                lblTestId.Text = match_id.ToString();
    //                con.Close();
